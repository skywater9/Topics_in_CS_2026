...
public class PathFinder {
    public static void main(String[] args) {
        ...
        String absolutePath = "/Users/demirgoksu/Desktop/path-activity/absolute.txt";
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(absolutePath))) {
            ...
            System.out.println(
                    "FAIL: Could not find the absolute file. Did you update the path string?");
        }
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(relativePath))) {
            ...
            System.out.println(
                    "FAIL: Could not find the relative file. Are you in the right folder?");
        }
    }
}
